...
//+songshiyang.wt, ADD, 2022/02/25, add main camera w2sc1300mcsfronttxd eeprom bring up
				...
				size = imgSensorReadEepromData(&w2sc1300mcsfronttxd_eeprom_data,w2sc1300mcsfronttxd_Checksum);
				if(size != w2sc1300mcsfronttxd_eeprom_data.dataLength || 
                  (w2sc1300mcsfronttxd_eeprom_data.sensorVendorid >> 24) != w2sc1300mcsfronttxd_read_eeprom(0x0001)) {
					...
					printk("w2sc1300mcsfronttxd get eeprom data failed %d\n",size);
					*sensor_id = 0xFFFFFFFF;
					return ERROR_SENSOR_CONNECT_FAIL;
				} else {
					LOG_INF("w2sc1300mcsfronttxd get eeprom data success\n");
					imgSensorSetEepromData(&w2sc1300mcsfronttxd_eeprom_data);
				}
#endif
//-songshiyang.wt, ADD, 2022/02/25, add main camera w2sc1300mcsfronttxd eeprom bring up

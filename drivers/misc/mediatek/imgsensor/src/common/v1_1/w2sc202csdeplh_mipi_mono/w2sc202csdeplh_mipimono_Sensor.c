...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
        ...
        do {
            *sensor_id = return_sensor_id();
            ...
            if ((*sensor_id == imgsensor_info.sensor_id) && (W2S5KJN1REARTRULY_SENSOR_ID == main_sensor_id)){
				...
				printk("1 supply dualcam(w2s5kjn1reartruly_mipi_raw + w2sc202csdeplh_mipi_mono) sensor id match!!");
                return ERROR_NONE;
            }   
    ...
    if ((*sensor_id != imgsensor_info.sensor_id) || (W2S5KJN1REARTRULY_SENSOR_ID != main_sensor_id)) {
		...
		printk("1 supply dualcam(need:w2s5kjn1reartruly_mipi_raw + w2sc202csdeplh_mipi_mono) sensor id not match!!,main_sensor_id:0x%x,depth sensor id:0x%x\n",main_sensor_id,*sensor_id);
